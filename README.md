# Star Tribune - Minnesota Poll 2017: State Government
...
1. Get code and enter project: `git clone https://github.com/striblab/20170503-mnpollv3-stategov.git && cd 20170503-mnpollv3-stategov.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170503-mnpollv3-stategov/ && rsync -rav ./ ../20170503-mnpollv3-stategov/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
